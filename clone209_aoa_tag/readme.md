...
Every 30 seconds the periodic advertisement payload is updated.  The code running on the C209 tag I am working with incorrectly implements the Manufacturer
Specific Data.  It formats it as

|length=1+sizeof(data)|type=0xff|data[]|
|------|---------|------|

The correct format is

|length=3+sizeof(data)|type=0xff|uuid16|data[]|
|---------------------|---------|------|------|

Where uuid16 is the 16-bit UUID of the manufacturer.  

For this example I have corrected this and use Silicon Labs UUID, 0x02FF.
